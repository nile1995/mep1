...
支吊架统计操作界面如图8.4\-1，按统计类型分为：类型统计、 型材统计两种。统计范围包括全部统计和范围统计。可以绘制到图，或者输出成word文档。

![](file:///C:\Users\pkpm\AppData\Local\Temp\ksohtml8136\wps4.jpg)

图表 8.4\-1支吊架统计

详细介绍：

\[**类型统计**\] 按类型统计项包括：支吊架类别、相同类型尺寸规格支吊架数量、型材类型、型材规格、相同规格型材个数、单个长度、总长度、支吊架总数量在表格最下方。     

\[**型材统计**\] 统计项包括型材类型、型材尺寸、单个长度、个数、总长度。所有型材总计在表格最下方，包括总的个数、和总长度。如8.4\-2。

![](file:///C:\Users\pkpm\AppData\Local\Temp\ksohtml8136\wps5.jpg)

图8.4\-2支吊架按型材统计

\[**全部统计**\] 统计工程内所有支吊架。

\[**范围统计**\] 统计框选范围内所有支吊架。如图8.4\-3。

![](file:///C:\Users\pkpm\AppData\Local\Temp\ksohtml8136\wps6.jpg)
