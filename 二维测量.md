...
二维测量工具界面如图表10.9\-2所示。在界面中可以选择测量需要的参考视图，对应软件左下角的提供的五种视图。

![](file:///C:\Users\pkpm\AppData\Local\Temp\ksohtml8136\wps69.jpg)

图表 10.9\-2二维测量工具界面

\[鼠标操作\] 在工程中左键点取两点，则会显示两点间投影至参考视图对应的二维平面上的二维距离。

\[俯视图\] 以X轴正方向和Y轴正方向为坐标的二维平面，作为当前二维测量的参考视图。

\[前视图\] 以X轴正方向和Z轴正方向为坐标的二维平面，作为当前二维测量的参考视图。

\[后视图\] 以X轴负方向和Z轴正方向为坐标的二维平面，作为当前二维测量的参考视图。

\[左视图\] 以Y轴负方向和Z轴正方向为坐标的二维平面，作为当前二维测量的参考视图。

\[右视图\] 以Y轴正方向和Z轴正方向为坐标的二维平面，作为当前二维测量的参考视图。

注意：Esc退出二维测量工具，右键开始新的测量。